...
public class ConfigHandler {
    ...
    public static void syncConfig() {
        ...
        chiselTerrasteelEnabled = config.get(chisels, "chiselTerrasteelEnabled", true).getBoolean();
        ...
        durabilityTerrasteel = config.get(durability, "durabilityTerrasteel", 2300).getInt();
